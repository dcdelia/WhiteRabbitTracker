...
VOID setupTaintTrackingPolicy() {
	memset(policyForTT, 0, TT_TOTAL_SIZE);
	
	policyForTT[TT_CPUID] = TAINT_COLOR_1;
	policyForTT[TT_RDTSC] = TAINT_COLOR_2;
	...
	policyForTT[TT_NTQSI_PROCESSINFO] = TAINT_COLOR_6;
	//policyForTT[TT_NTQSI_MODULEINFO] = TAINT_NTQSI_MODULEINFO;
	policyForTT[TT_NTQSI_FIRMWAREINFO] = TAINT_COLOR_3;
	...
	policyForTT[TT_GETSYSTEMINFO] = TAINT_COLOR_5;
	...
	policyForTT[TT_GETTICKCOUNT] = TAINT_COLOR_4;
	...
	policyForTT[TT_NTQIP_PROCESSBASICINFO] = TAINT_COLOR_7;
